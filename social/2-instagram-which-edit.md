# Caption for 2-instagram-which-edit.png

Graphic built by `scripts/build-social.py` (post 2). Edit the copy there, not in
the HTML.
...
Not sure which one you need? Say what stage you're at and I'll tell you, free, even when the answer is "none of them yet".

Send your first 1,000 words and I'll edit them properly at no charge, so you can see the difference rather than take my word for it.
...
- This is the post that earns the others. It answers the question every first
  time client asks, and answering it honestly is the whole differentiator.
- The "none of them yet" line is deliberate. Turning work away in public is the
  most credible thing on the account.
