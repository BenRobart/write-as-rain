# Caption for 6-instagram-book-blurb.png

Graphic built by `scripts/build-social.py` (post 6). Edit the copy there, not in
the HTML.

## Caption

```
Nobody reads chapter one in the shop. They read the back, and they decide there.

Which means 150 words you wrote last, in a hurry, after eighteen months on the manuscript, are carrying the whole thing. It's the most-read page of your book by an enormous margin and usually the least-worked.
...
- "A blurb withholds. A synopsis tells." is the line the post is built on. If
  the caption needs cutting, cut from the pricing paragraph instead.
- The free critique offer is the same shape as the free sample edit and should
  stay in every post that can honestly carry one.
